...
if (isset($_POST['wp_50_form_submit']) && $_POST['wp_50_form_submit'] == 'yes')
{
	...
	{	
		...
		$wpdb->query($sSql);
		$wp_50_success = __('Image details was successfully updated.', 'wp-photo-text');
	}
}
...
<div class="form-wrap">
	...
	<form name="wp_50_form" method="post" action="#" onsubmit="return wp_50_submit()"  >
      ...
      <p class="submit">
        <input name="publish" lang="publish" class="button add-new-h2" value="<?php _e('Update Details', 'wp-photo-text'); ?>" type="submit" />
