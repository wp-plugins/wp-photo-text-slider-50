...
###### Link      : http://www.gopiplus.com/work/2011/05/08/wordpress-plugin-wp-photo-slider-50/  						######
##############################################################################################################################
-->
...
<div class="wrap">
  <?php
  	global $wpdb;
    $title = __('Wp photo text slider 50');
  ...
  <table width="100%">
    <tr>
      <td align="right"><input name="text_management" lang="text_management" class="button-primary" onClick="location.href='options-general.php?page=wp-photo-text-slider-50/image-management.php'" value="Go to - Image Management" type="button" />
        <input name="setting_management" lang="setting_management" class="button-primary" onClick="location.href='options-general.php?page=wp-photo-text-slider-50/wp-photo-text-slider-50.php'" value="Go to - Gallery Setting" type="button" />
      </td>
    </tr>
  </table>
